...
import { deleteAccessToken, getAccessToken } from '../../redux/actions/userCredentialAction';
...
const Welcome = () => {
    ...
    const access_token = state.userCredentialsReducer;
    console.log("test here", state.userNameReducer);
